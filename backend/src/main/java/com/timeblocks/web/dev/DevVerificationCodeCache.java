...
/**
 * Dev-only in-memory cache for storing plaintext verification codes.
 * This allows devs to retrieve verification codes for testing without checking emails.
 * Should NOT be used in production.
 */
@Profile("dev")
@Component
public class DevVerificationCodeCache {
    ...
    /**
     * Retrieve the most recent verification code for an email address.
    ...
    /**
     * Remove the verification code for an email (e.g., after successful verification).
     */
