...
export default function TaskDeleteModal({ isOpen, task, onConfirm, onCancel }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-lg shadow-xl p-6 max-w-md w-full mx-4 z-10">
        <h2 className="text-xl font-bold text-gray-800 mb-3">Delete Task</h2>
        <p className="text-sm text-gray-700 mb-6">
          Are you sure you want to delete “{task?.title || task?.name}”?
